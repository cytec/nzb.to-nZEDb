...
// CAHNGE THIS:
define('TMDB_KEY', 'TMDBAPIKEY');
define('SALT_KEY', 'SUPERSECRETSALTK');
define('TORPROXY', 'PROXYIP:9050');

//ADDITIONAL CONFIG change only if you knwo what you are doing
...
var_dump($_SERVER);
define('API_BASE', isset($_SERVER["HTTPS"]) ? "https://" : "http://" . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]);
